    ...
    <section className=" px-6 py-12 lg:px-24">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="text-lg leading-relaxed text-gray-600">
          At Aakash Institute, we are dedicated to helping you achieve your dreams of studying, working, or living
          abroad. With our expert guidance and personalized services, we simplify the process of international
          relocation, ensuring that every step of your journey is seamless and stress-free.
        </p>
